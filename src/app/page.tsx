...
export default function Dashboard() {
 ...
 const fetchTickets = async () => {
  console.log("🚀 [FRONT] Iniciando fetchTickets")

  try {
    console.log("🌐 Haciendo request a /api/tickets...")
    ...
    // ⚠️ aquí detectamos si es HTML o JSON
    try {
      ...
      console.error("👉 Probablemente recibiste HTML")
    ...
    console.log("🏁 fetchTickets terminado")
    setLoading(false)
  }
}
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (ticketIndex !== -1) {
          ...
          )// React no verá esto como un cambio de estado válido
        }
      }
    } catch (error) {
